...
module.exports = {
    ...
    configure_service_laengereSchnur: async function configure_service_laengereSchnur() {
        ...
        await page.locator("#configurator-options > dl > :nth-child(16) > .input-box > select").waitForTimeout(500);
        await page.locator("#configurator-options > dl > :nth-child(16) > .input-box > select").FIXME_select(data.wunschseite);
        await page.locator("#configurator-options > dl > .last > .input-box > textarea").waitForTimeout(500);
