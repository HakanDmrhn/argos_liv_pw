...
test.describe('Integration test with visual testing - simulated mobile testing on raffrollo category page', function () {
    ...
    test('mobile testing on raffrollo category page', async function ({ page }) {
        ...
        // activate tooltip of Luogo 9107
        await page.locator('img[alt="Luogo 9107"]').click();
        ...
        // take argos screenshot
        await argosScreenshot(page, 'mobile view raffrollo - active tooltip - Luogo 9107', { fullPage: false });

        // deactivate tooltip of Luogo 9107
        await page.locator('div.tooltip.active').click();

        // take argos screenshot
        await argosScreenshot(page, 'mobile view raffrollo - tooltip closed - Luogo 9107', { fullPage: false });
        ...
        // deactivate tooltip of Chiave 9099
        await page.locator('div.tooltip.active').click();
